...
<!-- 					<p @click="FxShow" class="oldhousedetails-wnr-p"><img src="static/images/firstLevelPage/secondLevelPage/b-fenxiang.png" alt="">
						...
						<el-collapse-transition>
							<ul v-show="fxShow">
								...
								<li title="点击分享">
									<img src="static/images/firstLevelPage/secondLevelPage/lang.png" alt="">
									<p>微博</p>
								</li>
								<li title="点击复制">
									<img src="static/images/firstLevelPage/secondLevelPage/chaolianjie.png" alt="">
									<p>复制链接</p>
								</li>
							</ul>
						</el-collapse-transition>
...
export default {
      ...
      slides: [
        {
          ...
          srcTwo: require('../../../../static/images/firstLevelPage/secondLevelPage/vr.png'),
          title: '1',
        },
        {
          src: require('../../../../static/images/firstLevelPage/secondLevelPage/house.jpg'),
        ...
        {
          src: require('../../../../static/images/firstLevelPage/secondLevelPage/a-follow1.png'),
          srcTwo: require('../../../../static/images/firstLevelPage/secondLevelPage/vr.png'),
          title: '2',
        },
        {
        ...
        {
          src: require('../../../../static/images/firstLevelPage/secondLevelPage/a-follow2.png'),
          srcTwo: require('../../../../static/images/firstLevelPage/secondLevelPage/vr.png'),
          title: '3',
        },
        {
        ...
        {
          src: require('../../../../static/images/firstLevelPage/secondLevelPage/b-fenxiang.png'),
          srcTwo: require('../../../../static/images/firstLevelPage/secondLevelPage/vr.png'),
          title: '4',
        },
      ],
  ...
  methods: {
  	...
  	//data 数据加变量
  	shi () {
  		this.smallNavs[5].text = '点评('+this.nav+')'
  	},
  	//滚动导航栏 添加class
  	addClass (index) {
  		this.cour = index
  		// document.querySelector(''+this.smallNavs[index].to+'').scrollIntoView(true)
  		let top = document.querySelector(''+this.smallNavs[index].to+'').offsetTop
  		document.documentElement.scrollTop = top-76
  		document.body.scrollTop = top-76
  	},
  	//房源图片title 添加class
  	addClassTwo (index) {
  		this.courTwo = index
